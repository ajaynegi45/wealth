...
export function Header() {
  return (
    <header className="fixed top-0 w-full z-50 bg-background/80 dark:bg-background/80 backdrop-blur-xl ">
      <div className="flex justify-between items-center px-6 md:px-10 h-16 max-w-7xl mx-auto">
        ...
        <div className="flex items-center gap-4">
          ...
          <button className="font-medium text-sm px-5 py-2.5 bg-tint text-white rounded-full hover:bg-tint/90 transition-all shadow-md">
            Get Started
          </button>
        </div>
      </div>
